            ...
            <div className="flex flex-wrap -mx-4 justify-center">
              {slice?.items?.map((item, index) => (
                <div key={index} className="px-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 mb-10">
                  <div className="flex flex-col items-center overflow-hidden bg-[#171717] rounded-lg shadow-lg transform transition duration-300 p-6 border border-[#f0eee3] hover:-translate-y-2">
